...
import { Menu as MenuIcon, Image as ImageIcon, MessageSquare, LayoutDashboard, ChevronRight } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center h-full text-center space-y-8 py-12">
      ...
      <div className="space-y-2">
        ...
        <p className="text-stone-500 max-w-md">
          Manage your restaurant's presence with these quick actions.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg">
        <Link 
          to="/admin/menu" 
          className="p-6 bg-white border border-stone-100 rounded-3xl shadow-sm hover:shadow-md transition-all flex flex-col items-center gap-3 group"
        >
