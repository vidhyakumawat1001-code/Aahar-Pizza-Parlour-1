        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link 
                to="/menu" 
                className="px-8 py-4 bg-brand-red hover:bg-red-900 text-white font-bold rounded-xl transition-all flex items-center gap-2 shadow-lg shadow-brand-red/20"
              >
                Explore Menu <ChevronRight className="w-5 h-5" />
              </Link>
              <Link 
                to="/gallery" 
                className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white font-bold rounded-xl transition-all"
              >
                View Gallery
              </Link>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-brand-yellow/10 rounded-[3rem] p-12 md:p-20 flex flex-col md:flex-row items-center gap-12 border border-brand-yellow/20">
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <Link 
              to="/review" 
              className="inline-flex items-center gap-2 px-8 py-4 bg-brand-red text-white font-bold rounded-2xl hover:bg-red-900 transition-all shadow-lg shadow-brand-red/20"
            >
          ...
          <div className="flex-1 grid grid-cols-2 gap-4">
            <div className="space-y-4">
              ...
              <div className="h-48 bg-stone-900 rounded-2xl overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1574129624864-387bb975583e?auto=format&fit=crop&q=80&w=400" 
                  alt="Happy Customer"
            ...
            <div className="space-y-4 pt-8">
              <div className="h-48 bg-orange-200 rounded-2xl overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&q=80&w=400" 
                  alt="Pizza Party"
        ...
        <div className="bg-stone-900 rounded-[3rem] p-12 md:p-24 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl space-y-8">
            ...
            <p className="text-stone-400 text-lg">
              Visit us today or order online for a truly unforgettable dining experience.
            </p>
            <div className="flex items-center gap-8 text-white">
              <div className="flex items-center gap-2">
                <MapPin className="w-5 h-5 text-brand-yellow" />
                <span className="text-sm font-medium">123 Pizza Lane, Foodie City</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-5 h-5 text-brand-yellow" />
                <span className="text-sm font-medium">Open 11 AM - 11 PM</span>
              </div>
            </div>
          </div>
        </div>
